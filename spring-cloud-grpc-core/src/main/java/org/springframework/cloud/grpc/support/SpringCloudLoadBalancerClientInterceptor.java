 ...
 * @date 2022.07.15
 */
public class SpringCloudLoadBalancerClientInterceptor implements ClientInterceptor {

    private static final Logger LOGGER = LoggerFactory.getLogger(SpringCloudLoadBalancerClientInterceptor.class);
    ...
    public SpringCloudLoadBalancerClientInterceptor(String application,
